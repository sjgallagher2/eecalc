// Generated by Bisonc++ V4.13.01 on Sun, 16 Oct 2016 08:35:38 -0400
...
#line 22 "bisonparser.y"
        {
         double im = std::imag(d_vsp__[0]);
         double re = std::real(d_vsp__[0]);
         *output_stream << re;
         }
        break;

        case 4:
#line 32 "bisonparser.y"
        {
