// Generated by Bisonc++ V4.13.01 on Sat, 22 Oct 2016 19:15:38 -0400
...
PI__ const s_productionInfo[] = 
{
     ...
     {260, 8}, // 29: token ('t') ->  't' 'a' 'u' '(' token ',' token ')'
     {260, 7}, // 30: token ('L') ->  'L' 'C' '(' token ',' token ')'
     {260, 6}, // 31: token ('s') ->  's' 'i' 'n' '(' token ')'
     {260, 6}, // 32: token ('c') ->  'c' 'o' 's' '(' token ')'
     {260, 6}, // 33: token ('t') ->  't' 'a' 'n' '(' token ')'
     {260, 7}, // 34: token ('a') ->  'a' 's' 'i' 'n' '(' token ')'
     {260, 7}, // 35: token ('a') ->  'a' 'c' 'o' 's' '(' token ')'
     {260, 7}, // 36: token ('a') ->  'a' 't' 'a' 'n' '(' token ')'
     {260, 7}, // 37: token ('s') ->  's' 'i' 'n' 'h' '(' token ')'
     {260, 1}, // 38: token ('e') ->  'e'
     {260, 2}, // 39: token ('p') ->  'p' 'i'
     {261, 1}, // 40: startrule_$ ->  startrule
};
...
#line 161 "bisonparser.y"
        {
         d_val__ = {std::real(d_vsp__[-3])*std::real(d_vsp__[-1]),0};
         }
        break;
